...
public class Uygulama : IEntity<int>, IKiraciEntity
{
    ...
    public bool? YeniGelistirmelerveTedarik { get; set; }
    public bool? KritikAltyapiSistemi { get; set; }

    [MaxLength(50)] public string? IpAdresi { get; set; }

    [MaxLength(500)] public string? UrlAdresi { get; set; }

    [MaxLength(500)] public string? YazilimSurumu { get; set; }

    [MaxLength(500)] public string? YazilimYayimcisi { get; set; }
    public DateTime? EdinimTarihi { get; set; }
    public int? LisansAdedi { get; set; }
    public int? LisansTakipSorumlusuId { get; set; }
    public int? DestekDurumuId { get; set; }

    [MaxLength(500)] public string? DestekAlinanTedarikci { get; set; }

    [MaxLength(500)] public string? BakimSuresi { get; set; }

    [MaxLength(500)] public string? BakimKapsami { get; set; }

    [MaxLength(500)] public string? YaziliminYuklendigiDonanimlar { get; set; }

    [MaxLength(500)] public string? VeritabaniveSurumu { get; set; }

    [MaxLength(500)] public string? VeritabaniVersiyonu { get; set; }
    ...
    public virtual DestekDurumu? DestekDurumu { get; set; }
