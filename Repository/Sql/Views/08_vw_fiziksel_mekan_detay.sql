DROP VIEW IF EXISTS vw_fiziksel_mekan_detay CASCADE;

CREATE VIEW vw_fiziksel_mekan_detay AS
SELECT
    t.id,
    t.organizasyon_id,
    kat.ad                                              AS kategori,
