DROP VIEW IF EXISTS vw_veritabani_detay CASCADE;

-- Bu görünümde rpo/rto/mtpd birleştirilmez: karşılık gelen DTO sayı ve birimi
-- ayrı alanlarda bekler, birleştirmeyi arayüz yapar.
CREATE VIEW vw_veritabani_detay AS
SELECT
    t.id,
    t.organizasyon_id,
    kat.ad                                              AS kategori,
    ...
    ev_hayir(t.yeni_gelismelerve_tedarik)               AS yeni_gelismelerve_tedarik,
