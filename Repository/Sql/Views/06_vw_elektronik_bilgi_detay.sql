DROP VIEW IF EXISTS vw_elektronik_bilgi_detay CASCADE;

CREATE VIEW vw_elektronik_bilgi_detay AS
SELECT
    t.id,
    t.organizasyon_id,
    kat.ad                                              AS kategori,
    ...
    t.saklama_suresi::text                              AS saklama_suresi,
    t.saklama_suresi_tip,
    t.notlar,
    t.envantere_giris_tarihi,
    t.envanter_guncelleme_tarihi,
    t.envanterden_cikis_tarihi
FROM elektronik_bilgiler t
