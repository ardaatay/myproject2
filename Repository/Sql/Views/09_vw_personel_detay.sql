DROP VIEW IF EXISTS vw_personel_detay CASCADE;

-- Buradaki "personel", envanterdeki insan kaynağı varlığıdır; sistem
-- kullanıcılarıyla (kullanicilar tablosu) ilgisi yoktur.
CREATE VIEW vw_personel_detay AS
SELECT
    t.id,
    t.organizasyon_id,
    kat.ad                                              AS kategori,
    ...
    t.kurtarma_planlari,
    ev_hayir(t.vekalet_edilme_durumu)                   AS vekalet_edilme_durumu,
    t.notlar,
