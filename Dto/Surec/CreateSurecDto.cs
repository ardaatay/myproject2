...
public class CreateSurecDto
{
    ...
    [Required(ErrorMessage = "Rpo tipi zorunludur.")]
    ...
    [Required(ErrorMessage = "Rto tipi zorunludur.")]
    ...
    [Required(ErrorMessage = "Mtpd tipi zorunludur.")]
